  ...
  <div className="section-four-container" onWheel={this.props.onWheel}>
    <div className="container-fluid pl-0 pr-0">
      <div className="container no-gutter">
        <div className={`section-four text-center pt-2 ${window.innerWidth >= 725 ? (this.props.mouseScroll > 0 ? 'shift-technology-section' : '') : ''}`}>
          <h1 className="font-weight-bold mt-3 pt-5">TECHNOLOGIES WE USE</h1>
          <hr />
              <div className={`row ${window.innerWidth>425 && window.innerWidth<769?'':' py-5'}`}>
      ...
      <footer style={window.innerWidth < 725 ?makeFooterVisibeForSmallDevice.reset:{}} className={(this.props.mouseScroll > 0 && window.innerWidth >= 725) ? 'show-footer' : ''}>
