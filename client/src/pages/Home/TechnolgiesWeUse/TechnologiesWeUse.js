  ...
  render = (props) => {
      ...
      return ( 
            <React.Fragment>
                ...
                <div className={`section-four text-center pt-2 ${this.props.getValue > 0 ? 'shift-technology-section' : ''}`}>
              ...
              <footer className={(this.props.getValue>0)?'show-footer':''}>
