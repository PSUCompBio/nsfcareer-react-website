                ...
                <div className="section-two pt-4 ">
                  <div className="row">
                    <div className="col-md-12 col-lg-12 pt-5 text-center">
                      ...
                      <hr />
                      <p className={`${window.innerWidth>425 && window.innerWidth<768?'pt-5 mt-5':''}`}>Brain injuries are a significant health concern for civilian and military populations.
