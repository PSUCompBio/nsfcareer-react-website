            ...
            <div className="section-four text-center">
              <div className="row">
                <div className="col-md-4 col-lg-4 text-left">
                  ...
                  <p>
                    We partner with leading impact and blast <br /> sensor
                    companies to provide real-time <br /> brain response
                    analytics. We help <br /> transform their data into <br />
                    meaningful brain health monitoring. <br /> Looking for a
                    sensor? See our <br /> recommended providers here.
                  </p>
                </div>
                <div className="col-md-4 col-lg-4 pt-5 ">
                  <img
                    className="mb-5 img-fluid terminology-img"
                    src="/img/FooterImg/terminology.png"
                    alt=""
                  />
                </div>
                <div className="col-md-4 col-lg-4 text-right">
                  ...
                  <p>
                    Computational Brain Medicine (CBM) is a transformative and
                    emerging discipline that <br /> uses computers to
                    understand, diagnose,
                    <br /> develop treatment options, and monitor <br /> brain
                    health. It leverages engineering,
                    <br /> mathematics and computational science to <br />{' '}
                    develop quantitative approaches for brain
                    <br />
                    health applications.
                  </p>
                </div>
