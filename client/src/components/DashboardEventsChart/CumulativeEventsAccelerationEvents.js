    ...
    return (
      <div className="row cumm mb-5 ">
        <div className="col-md-12 col-lg-12">
          <CumulativeAccelerationEventChart brainRegions={this.props.brainRegions} user={this.state.user} team={this.state.team} is_selfie_image_uploaded={this.state.is_selfie_image_uploaded}  imageUrl={this.state.imageUrl} data={this.props.data}/>
