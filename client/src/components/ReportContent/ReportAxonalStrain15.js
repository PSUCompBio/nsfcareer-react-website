...
class ReportAxonalStrain15 extends React.Component {
    constructor(props) {
        super(props);
                                    ...
                                    <View style={styles.col12}>
                                        ...
                                        <View style={styles.rowHead2}>
                                             <View style={styles.tableRowCenter}>
                                                <Text style={styles.tableColRight4}>{csdm ? csdm : '0'}% of brain tissue has exceeded Axonal Strain</Text>
...
export default ReportAxonalStrain15;
