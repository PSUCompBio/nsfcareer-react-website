      ...
      users: [
        {
          ...
          plyPath: '',
          originalImagePath:
            'https://avatar3d.s3.amazonaws.com/images/vlima.png',
          download: 'none',
          createAvatar: 'block',
          isLoading: false
        },
        {
          ...
          plyPath: '',
          originalImagePath:
            'https://avatar3d.s3.amazonaws.com/images/asdf.jpg',
          download: 'none',
          createAvatar: 'block',
          isLoading: false
        },
        {
          ...
          plyPath: '',
          originalImagePath:
            'https://avatar3d.s3.amazonaws.com/images/Reuben.jpg',
          download: 'none',
          createAvatar: 'block',
          isLoading: false
        },
        {
          ...
          plyPath: '',
          originalImagePath:
            'https://avatar3d.s3.amazonaws.com/images/ritikamenghani.png',
          download: 'none',
          createAvatar: 'block',
          isLoading: false
        }
                      ...
                      {user.isLoading ? (
                        ...
                        <div>
                          <button
                            ...
                            style={{ display: user.createAvatar }}
                            onClick={() =>
                              this.handleClick(
                                user.id,
                                user.firstname,
                                user.originalImagePath
                              )
                            }
                          >
                            Create Avatar
                          ...
                          <button
                            className="btn btn-primary"
                            style={{ display: user.download }}
                            onClick={() => this.urlOpen(user.plyPath)}
                          >
                            Download Avatar
                          </button>{' '}
                        </div>
