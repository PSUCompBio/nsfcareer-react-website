      ...
      <React.Fragment>
        ...
        <div className="charts-container">
          <Accordion className="player-collapes-div">
            {this.state.cumulativeAccelerationTimeAllRecords.length > 0 && this.state.cumulativeAccelerationTimeAllRecords[0].sensor_data ? this.state.cumulativeAccelerationTimeAllRecords.map((item, index) => ( 
              <Card >
                <Card.Header>
